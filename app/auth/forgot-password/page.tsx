    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-black via-gray-950 to-black flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mt-6">
          <Link
            href="/"
            className="inline-flex items-center justify-center px-6 py-2 text-sm font-semibold text-white/90 hover:text-white bg-white/15 hover:bg-white/20 border border-white/30 rounded-lg transition-all"
          >
            ← 메인으로
          </Link>
        </div>
