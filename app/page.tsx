...
export const metadata: Metadata = {
  ...
  description: '틱톡킬라는 TikTok, Douyin 영상을 한눈에 검색하고 분석하는 도구입니다. 틱톡 킬라로 인기 콘텐츠를 발견하고 크리에이터를 분석하세요.',
  keywords: ['틱톡킬라', '틱톡 킬라', 'TikTalk Killa', 'TikTok 검색', '틱톡 검색', '틱톡 분석', 'Douyin', '숏폼', '영상 검색', '크리에이터 검색'],
  ...
  openGraph: {
    ...
    description: '틱톡킬라는 TikTok, Douyin 영상을 한눈에 검색하고 분석합니다. 틱톡 킬라로 인기 콘텐츠를 발견하세요.',
    images: [
      {
